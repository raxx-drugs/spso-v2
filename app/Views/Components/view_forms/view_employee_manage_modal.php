...
<div class="modal fade" id="viewEmployeeModal" tabindex="-1" aria-labelledby="viewEmployeeModalLabel"
  aria-hidden="true">
  <!-- REMINDER FOR NORMAL MODAL USE "modal-xl" if editing the information portal use fullscreen -->
    ...
    <div class="modal-content">
      ...
      <form id="viewEmployeeModalForm" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header">
          <h5 class="modal-title" id="viewEmployeeModalLabel">Employee Modal</h5>
